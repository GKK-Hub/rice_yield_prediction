...
```{python}
filtered_df['temperature'] = (filtered_df['min_temperature'] + filtered_df['max_temperature']) / 2
filtered_df.drop(columns=['irrigated_area', 'production', 'max_temperature', 'min_temperature'], inplace=True)
```

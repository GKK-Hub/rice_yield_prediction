...
# fig_summary, ax_summary = plt.subplots(figsize=(15, 10))
# shap.plots.bar(shap_val, ax=ax_summary)
# plt.close()
```
...
```{python}
# plt.style.use("fivethirtyeight")
# fig_beeswarm, ax_beeswarm = plt.subplots(figsize=(15, 10))
# shap.plots.beeswarm(shap_val, max_display=20, ax=ax_beeswarm, plot_size=None)
# plt.close()
```
